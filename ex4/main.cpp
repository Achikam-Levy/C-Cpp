...
//  Matrix a(3,3);
//  Matrix b(a);
////  std::cout<<" rows: "<< a.get_rows() << " cols: " << a.get_cols() << endl;
////  Matrix b(3, 4);
////  std::cout<<" rows: "<< b.get_rows() << " cols: " << b.get_cols() << endl;
////  b = a;
//  a.plain_print();
////  b.transpose();
////  std::cout<<" rows: "<< a.get_rows() << " cols: " << a.get_cols() << endl;
...
////  c.plain_print();
//
//  c = activation::softmax (a);
////  std::cout<<" sum: "<< a.sum() <<  endl;
////  std::cout<<" norm: "<< a.norm() <<  endl;
////  std::cout<<" argmax: "<< a.argmax() <<  endl;
////  a += b;
////  Matrix c;
////  c = a;
////  c[5];
